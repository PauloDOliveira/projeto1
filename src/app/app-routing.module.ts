...
const routes: Routes = [
  ...
  // { path: 'form-home', loadChildren: './home/form-home/form-home.module#FormHomePageModule' },
  { path: 'form-agendamento', loadChildren: './agendamento/form-agendamento/form-agendamento.module#FormAgendamentoPageModule' },
